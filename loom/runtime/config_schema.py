...
SPEC: list[SpecEntry] = [
    ...
    {
        "section": "chat",
        "key": "project_memory_max_tokens",
        "label": "Budget fiche projet",
        "layer": "commun",
        "nature": "override",
        "type": "int",
        "applies": "live",
        "help": "Budget de la fiche projet loom.md (générée par /init) injectée au prompt.",
    },
    {
        "section": "chat",
...
ADVANCED = {
    ...
    ("chat", "project_memory_max_tokens"),
